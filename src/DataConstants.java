...
public abstract class DataConstants {
    //Files
    protected static final String ADMINISTRATOR_FILE_NAME = "./src/Administrator.json";
    protected static final String CASES_FILE_NAME = "./src/Cases.json";
    protected static final String CRIMINALS_FILE_NAME = "./src/Criminals.json";
    protected static final String DETECTIVES_FILE_NAME = "./src/Detectives.json";
    protected static final String EVIDENCE_FILE_NAME = "./src/Evidence.json";
    protected static final String PERSONS_OF_INTEREST_FILE_NAME = "./src/PersonsOfInterest.json";
    protected static final String POLICEMEN_FILE_NAME = "./src/Policemen.json";
    protected static final String SUSPECTS_FILE_NAME = "./src/Suspects.json";
    protected static final String VICTIMS_FILE_NAME = "./src/Victims.json";
    protected static final String WITNESSES_FILE_NAME = "./src/Witnesses.json";
    protected static final String TEST_FILE_NAME = "./src/Test.json";
